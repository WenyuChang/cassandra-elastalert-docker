...
RUN yum install -y unzip wget ntp.x86_64 ca-certificates openssl-devel.x86_64 openssl.x86_64 libffi-dev.x86_64 python-devel.x86_64 gcc.x86_64 compat-gcc-44.x86_64 libgcc.x86_64 tzdata.noarch; \
    rm -rf /var/cache/yum/*; \
